// Copyright (c) 2015 The DUMDUM developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("DUMDUM-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("DUMDUM-smsg-pow"); // Make this thread recognisable
