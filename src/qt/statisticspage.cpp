...
void StatisticsPage::updateStatistics()
{
    ...
    {
		subsidy = "171,900 GUM per block";
    }
	else if(pindexBest->nHeight < 99)
    {
		subsidy = "0 GUM per block - Instamine Prevention";
    }
	else if(pindexBest->nHeight < 1440)
    {
		subsidy = "1000 GUM per block";
    }
	else if(pindexBest->nHeight < 2880)
    {
		subsidy = "750 GUM per block";
    }
	else if(pindexBest->nHeight < 4320)
    {
        subsidy = "500 GUM per block"; 
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"lightgreen\">" + qVolume + " GUM" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"lightred\">" + qVolume + " GUM" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " GUM");
    }
